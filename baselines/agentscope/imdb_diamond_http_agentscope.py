...
def main(argv: List[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="IMDb diamond HTTP workflow with OpenAIChatModel + DB worker (Halo-aligned prompts)."
    )
    ...
    metrics.start(run_name="imdb_diamond_http", total_queries=len(queries))
    metrics.add_metadata("runner", "agentscope_imdb_diamond_http")
