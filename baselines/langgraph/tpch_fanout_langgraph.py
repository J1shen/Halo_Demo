...
def main(argv: List[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="TPC-H fanout LangGraph workflow (Halo-aligned prompts).")
    ...
    if args.query:
        ...
        if not queries:
            ...
            return 1
    metrics.start(run_name="tpch_fanout_langgraph", total_queries=len(queries))
