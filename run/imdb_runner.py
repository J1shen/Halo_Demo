...
DEFAULT_INPUT_FILE = Path("data/imdb_input.txt")
HALO_PG_DBNAME = "imdb"
...
def main(argv: List[str] | None = None) -> None:
    ...
    metrics.start_run("imdb", len(queries))
...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    cli = argparse.ArgumentParser(description="Run IMDb workflow over queries from a text file.")
    cli.add_argument(
        "-t",
        "--template",
        type=Path,
        default=Path("templates/imdb_diamond.yaml"),
